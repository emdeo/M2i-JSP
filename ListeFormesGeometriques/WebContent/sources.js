			...
			.on(
					...
					function() {
						if (this.id == 'rCarre') {
							...
							$("#dimensions")
							.html(
									"<div class='form-group row' class='col-md-12'><label for='txtLargeur'"
									+ "class='col-md-4 col-form-label'>Largeur :</label>"
									+ "<div class='col-md-6'>"
									+ "<input type='number' class='form-control' id='txtLargeur' name='txtLargeur'></div></div>"
									+ "<div class='form-group row' class='col-md-12'><label for='txtLongueur'"
									+ "class='col-md-4 col-form-label'>Longueur :</label>"
									+ "<div class='col-md-6'>"
									+ "<input type='number' class='form-control' id='txtLongueur' name='txtLongueur'></div></div>")
						}
					})
										...
										context.clearRect(0, 0, canvas.attr("width"),
												...
												$.ajax({
													...
													data : {
														...
														TypeForme : $(this).attr("data-typeForme")
													},
													contentType : "json",
													...
													success : function(resultat) {
														...
														if (type == "carre") {
															...
															context.fillRect(x, y, resultat._Cote, resultat._Cote)
														}
														else if (type == "cercle") {
															context.arc(x, y, resultat._Rayon, 0,
																	2 * Math.PI)
															context.fill()
														}
														else if (type == "rectangle") {
															context.fillRect(x, y, resultat._Largeur, resultat._Longueur)
														}
													}
												})
